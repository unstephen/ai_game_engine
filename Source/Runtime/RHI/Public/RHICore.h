...
inline bool IsSuccess(RHIResult result)
{
    return result == RHIResult::Success;
}
inline bool IsFailure(RHIResult result)
{
    return result != RHIResult::Success;
}
...
{
    return result == RHIResult::DeviceLost || result == RHIResult::DeviceRemoved || result == RHIResult::DeviceReset;
}
